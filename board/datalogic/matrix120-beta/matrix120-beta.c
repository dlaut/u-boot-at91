...
{
	/* QSPI0 - ioset 3 */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 14, 0);	/* SCK */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 15, 0); /* CS */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 16, 1); /* IO0 */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 17, 1); /* IO1 */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 18, 1); /* IO2 */
	atmel_pio4_set_c_periph(AT91_PIO_PORTA, 19, 1); /* IO3 */
